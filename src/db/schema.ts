...
export const documents = sqliteTable(
  "documents",
  {
    ...
    lifecycle: text("lifecycle", { enum: ["draft", "issued", "void"] })
      .notNull()
      .default("draft"),
    number: text("number"),
    ...
    customerSnapshot: text("customer_snapshot", { mode: "json" })
      ...
      .notNull(),
    senderSnapshot: text("sender_snapshot", { mode: "json" })
      .$type<SenderSnapshot>()
      .notNull(),
    ...
    quotationResponse: text("quotation_response", {
...
export const documentLines = sqliteTable(
  ...
  (table) => [
    ...
    uniqueIndex("document_lines_position_unique").on(
      table.documentId,
      table.position
    ),
  ]
...
export const numberSequences = sqliteTable(
  ...
  (table) => [
    uniqueIndex("number_sequences_type_year_unique").on(
      table.documentType,
      table.year
    ),
  ]
